...
enum class InputError(val errCode: Int, val textError: String) {
    ...
    INCORRECT_MSISDN_B(7,"Поле 'Номер вызваемого абонента' должен быть 9 цифр для РУз или 13 символов для МТР"),
    INCORRECT_START_TIME(8,"Поле 'Время вызова' должно соответсвовать маскам ЧЧ.ММ.СС или ЧЧ.ММ")
}